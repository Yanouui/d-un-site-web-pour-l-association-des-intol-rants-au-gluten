...
<div class="heading">
        ...
        <div class="contact-wrap">
            ...
            <div class="contact-in">
                <h1>Contact Info</h1>
                <h2><i class="fa fa-phone" aria-hidden="true"></i> Téléphone : 0559 17 99 82 </h2>
                
                <h2><i class="fa fa-envelope" aria-hidden="true"></i> Facebook : Magasin Bonjour </h2>
              
                <h2><i class="fa fa-map-marker" aria-hidden="true"></i> Addresse:</h2>
                 <h3> 56, lotissement Vincent, Bouzereah, Alger </h3>
    ...
    <div class="contact-wrap">
        ...
        <div class="contact-in">
            <h1>Contact Info</h1>
            <h2><i class="fa fa-phone" aria-hidden="true"></i> Téléphone : 
            0540 84 94 40   
             </h2>
         
            <h2><i class="fa fa-envelope" aria-hidden="true"></i> Instagram: dar_elkarim </h2>
           
            <h2><i class="fa fa-map-marker" aria-hidden="true"></i> Address :</h2>
            <h3>104, lotissement Les Rosiers, Ouled Fayet, Alger </h3>
...
<div class="contact-wrap">
    ...
    <div class="contact-in">
        <h1>Contact Info</h1>
        <h2><i class="fa fa-phone" aria-hidden="true"></i> Téléphone :  0799 41 00 22 </h2>
      
        <h2><i class="fa fa-envelope" aria-hidden="true"></i> Facebook :  S&R sans gluten</h2>
...
<div class="contact-wrap">
    ...
    <div class="contact-in">
        <h1>Contact Info</h1>
        <h2><i class="fa fa-phone" aria-hidden="true"></i> Téléphone :0555 64 00 00</h2>
        
        
        <h2><i class="fa fa-map-marker" aria-hidden="true"></i> Addresse :</h2>
        <h3> 67 cité Alioua Fodil route Ouled Fayet, Cheraga, Alger </h3>
...
<div class="contact-wrap">
    ...
    <div class="contact-in">
        <h1>Contact Info</h1>
        <h2><i class="fa fa-phone" aria-hidden="true"></i> Téléphone : 0558 71 19 45</h2>
       
        <h2><i class="fa fa-envelope" aria-hidden="true"></i> Facebook :S&R sans gluten </h2>
        
        <h2><i class="fa fa-map-marker" aria-hidden="true"></i> Addresse:</h2>
        <h3> Cité Douzi, Bab ezzouar </h3>
...
<div class="contact-wrap">
    ...
    <div class="contact-in">
        <h1>Contact Info</h1>
        <h2><i class="fa fa-phone" aria-hidden="true"></i> Téléphone : 0743 76 80 92</h2>
    
        <h2><i class="fa fa-envelope" aria-hidden="true"></i> Facebook : Miny Maïs  </h2>
        
        <h2><i class="fa fa-map-marker" aria-hidden="true"></i> Addresse :</h2>
        <h3> Rue Khabchiche Embarek, Laararsa, Sétif </h3>
...
<div class="contact-wrap">
    ...
    <div class="contact-in">
        <h1>Contact Info</h1>
        <h2><i class="fa fa-phone" aria-hidden="true"></i> Téléphone : 0552 83 81 35 </h2>
